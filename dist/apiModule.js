...
exports.default = (function () {
    ...
    var keysets = {
        'fieldroutes_default': {
            "base_url": "https://brighthousesolar.fieldroutes.com/api",
            "keys": ["2l6dhlhl6tltpfu98dpvb6770a0mrro8i1tcctk66ksurks44ceohif28o30um17"],
            "tokens": ["8ebgdsgiihnutdglcponabcvadj5166nmob6m8g2gnene3v0eqvb8q2385ouedcu"],
        }
    };
    var keysetUI;
    ...
    m.setKeyset = function (newKeyset) {
        ...
        if (typeof keysets[newKeyset] === 'undefined')
            return;
        keyset = newKeyset;
    ...
    m.init();
    m.call = function (endpoint, action, params) {
        return __awaiter(this, void 0, void 0, function* () {
            localStorage.callHistory = JSON.stringify(Object.assign({ 'endpoint': endpoint, 'action': action, 'time': (new Date().toISOString()) }, params)) + _nl + localStorage.callHistory; //TODO: convert search/get $.post to m.call
            return new Promise(function (resolve, reject) {
                ...
                //console.log(params);
                $.post(base_url + endpoint + '/' + action, params, function (response) {
    ...
    m.search = function (type, params, fullyResolveEverything) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            return new Promise(function (resolve, reject) {
                ...
                $.post(base_url + type + '/search', params, function (response) {
                    if (response.success == false || response.errorMessage) {
                        console.error(response.errorMessage);
    ...
    m.get = function (type, ids, primary_key) {
        return __awaiter(this, void 0, void 0, function* () {
            return new Promise(function (resolve, reject) {
                ...
                $.post(base_url + type + '/get', params, function (response) {
    ...
    m.staggeredRequest = function (type, ids, primary_key, threadCount) {
        return __awaiter(this, void 0, void 0, function* () {
            return new Promise(function (resolve, reject) {
    ...
    m.staggeredWrite = function (type, action, entities, threadCount, options) {
        return __awaiter(this, void 0, void 0, function* () {
            return new Promise(function (resolve, reject) {
    ...
    */
    ...
    m.recomplete = function (params, domain) {
        return new Promise(function (resolve, reject) {
            ...
            $.post(callUrl + params['endpoint'] + '/' + params['action'], params, function (response) {
